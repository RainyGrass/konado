...
3. Send an email to `konado@godothub.com` with the subject "Application to become a Konado maintainer", and include the above information in the email content.
